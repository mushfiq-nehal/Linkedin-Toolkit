...
export const tools: Tool[] = [
  ...
  },
  {
    ...
    category: 'analytics',
    icon: 'chart',
    href: '/linkedin-headline-analyzer/',
    featured: true,
  ...
  },
  {
    ...
    category: 'content',
    icon: 'tag',
    href: '/linkedin-hashtag-generator/',
    featured: false,
  ...
  },
  {
    ...
    category: 'templates',
    icon: 'message',
    href: '/linkedin-connection-message-templates/',
    featured: true,
  ...
  },
  {
    ...
    category: 'templates',
    icon: 'user',
    href: '/linkedin-about-section-templates/',
    featured: true,
